 ...
 */
#define DOCA_TELEMETRY_NETFLOW_MINIMUM_LAYER2_TOTAL_LENGTH 422
#define DOCA_TELEMETRY_NETFLOW_MINIMUM_LAYER2_TOTAL_LENGTH_DEFAULT_LENGTH 8
/**
 * Layer 2 length of the largest packet observed for this Flow. The packet length includes the
 * length of the layer 2 header(s) and the length of the layer 2 payload.
 */
#define DOCA_TELEMETRY_NETFLOW_MAXIMUM_LAYER2_TOTAL_LENGTH 423
#define DOCA_TELEMETRY_NETFLOW_MAXIMUM_LAYER2_TOTAL_LENGTH_DEFAULT_LENGTH 8
/**
